...
public class Exercise15_14 extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7253792168126626562L;
...
class BarChart1 extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6603567337191653317L;
	BorderLayout borderLayout1 = new BorderLayout();
	Color[] colors = { Color.red, Color.yellow, Color.green, Color.blue, Color.cyan, Color.magenta, Color.orange, Color.pink, Color.darkGray };
	String[] dataName;
	double[] data;
